...
\renewcommand{\coverletter} {
  ...
  thesis \texttt{supernest}, in a performance gain by a factor of 30,
  and a precision gain by a factor of 1000 at the same time. I also
  have a keen interest in looking at interactions between Quantum
  Mechanics, Statistical Physics and the Theory of Relativity. In my
  Latest work, I have attempted to create a Lorentz-covariant form of
  the Langevin equation and derived the reliativistic equivalent of
  the fluctuation-dissipation theorem. I sincerely wish that under
  Prof. Ferreira's supervision I shall be able to contribute to modern
  scientific discourse productively and usefully. 
