...
\renewcommand{\coverletter} {
  ...
  I'm a Physicist\cite{langev,measurement,cpi,charge-frac,cu2o}
  working as a full-time Consultant for Eclipse Laboratories
  Inc. performing the duties of a principal protocol engineer.  My
  work is mainly concerned with the design and implementation of the
  ``syzygy'' canonical bridge, where I do both research and
  development.  Before Eclipse I was a full-time technical lead for
  the Hyperledger Iroha v2 project, orchestrating the assembly of the
  core development team, decisions on technologies and the
  architecture of the ledger. My latest contributions to the project
  involved the design of a fully-dynamic permissions system, and an
  Iroha ISA\footnote{The goal is to support a fully programmable
  domain-specific VM, similar to Parity Substrate}.
}
...
\job{May\footnote{Contract negotiation} 2024}%
{Present}%
{Superchain}%
