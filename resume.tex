...
\section*{Work Experience} {\setlength{\parindent}{0in}
  ...
  \job{Sep
    2021}{Pres.} {Soramitsu}{Tech Lead} { Architect for Iroha v2, the
  ...
  \job{Oct
    2018}{present} {SkyEng} {Tutor/Mathematical Corrector} {Online
    ...
    the \examtype{ielts,} \examtype{toefl} and \examtype{cae.}. I was
    the top paid teacher in my department, showing the highest success
    rate in achieving the desired \examtype{ielts}
    score. }

  \section*{Education}

  \education{2019}{2020} {University
    of Cambridge} {MSci \nth{1}} { Physical Natural Sciences Tripos}
