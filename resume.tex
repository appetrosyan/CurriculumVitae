...
\renewcommand{\coverletter} {
  ...
  who works as a full-time Tech Lead at Hyperledger, a subsidiary of
  the Linux Foundation, currently leading the development and design
  of Hyperledger Iroha, the world's first parallel blockchain ledger.
  I'm involved with almost every aspect of Iroha, from the development
  of SDKs, architectural decisions of the base ledger, and
  contributions to our dependency projects, which until recently
  included Hyperledger Ursa. I believe that work on blockchains is
  making the world a better place, albeit slowly.
}
