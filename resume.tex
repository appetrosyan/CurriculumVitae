...
\renewcommand{\coverletter} {
  ...
  I'm a Physicist\cite{langev,cpi,charge-frac}
  working as a full-time Tech Lead at Hyperledger developing the
  ledger Iroha.  I'm the main architect, involved in research,
  development testing and maintenance of the project. My latest
  contributions to the project involved the design of a fully-dynamic
  permissions system, and an Iroha ISA.  The goal is to support a
  fully programmable domain-specific VM, similar to Parity Substrate.
