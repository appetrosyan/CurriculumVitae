...
\renewcommand{\coverletter} {
  ...
  I'm a former Physicist who works as a Tech Lead at Hyperledger, a
  ...
  University of Cambridge in 2020.  I've ranked near the top in both
  my Masters' (accelerated nested sampling\cite{cpi}), and Bachelor's
  (charge fractionalisation in Polyacetylene\cite{charge-frac})
  theses. I mainly focused on Quantum cryptography and quantum
  algorithms in my later years. I'm still an active scientist, I
  recently published two papers Relativistic Langevin equation derived
  from a particle-bath Lagrangian\cite{langev}, as well as ongoing
  work on \texttt{Supernest}\cite{sspr}.

  I'm the de-facto product owner of Iroha~2,  
